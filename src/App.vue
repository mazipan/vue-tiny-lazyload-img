<template>
  <div id="app">
    ...
    <header class="header header-dummy">
      <a href="/vue-tiny-lazyload-img/" alt="Home">
        <h1>Vue Tiny Lazyload Img</h1>
      </a>
      <div>
        <a href="https://github.com/mazipan/vue-tiny-lazyload-img"
            target="_blank" rel="noopener" alt="Github Link">
